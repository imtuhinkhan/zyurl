            ...
            <div class="card mb-5 border-0 shadow-sm text-center mx-1 position-relative">
                ...
                <div class="card-body rounded-bottom p-4 position-relative">
                    <ul class="list-unstyled mb-4 text-start text-dark">
                        <li class="mb-3"><span class="border-bottom" data-bs-toggle="tooltip" title="<?php ee('Number of short links allowed.') ?>"><?php ee("Short Links") ?></span><span class="float-end fw-bold"><?php echo $plan["urls"] == "0" ? '<i class="fa fa-infinity gradient-primary clip-text"></i>' : number_format($plan["urls"]).($plan['ismonthly'] ? '/'.e('mo') : '') ?></span></li>
                        <li class="mb-3"><span class="border-bottom" data-bs-toggle="tooltip" title="<?php ee('Total clicks allowed over a period') ?>"><?php ee("Link Clicks") ?></span><span class="float-end fw-bold"><?php echo $plan["clicks"] == "0" ? '<i class="fa fa-infinity gradient-primary clip-text"></i>' : number_format($plan["clicks"]).'/'.e('mo') ?></span></li>
                        <li class="mb-3"><span class="border-bottom" data-bs-toggle="tooltip" title="<?php ee('Amount of time statistics are kept for each short link.') ?>"><?php ee("Data Retention") ?></span><span class="float-end fw-bold"><?php echo $plan["retention"] == "0" ? '<i class="fa fa-infinity gradient-primary clip-text"></i>' : $plan["retention"].' '.e('days') ?></span></li>
