                                ...
                                <div class="card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <label class="btn border rounded text-dark px-5 py-4">
                                                <input type="radio" name="menutype" value="hybrid" class="me-2" autocomplete="off" '.(!$option->menutype || $option->menutype == 'hybrid' ? 'checked' : '').'> '.e('Top & Moving').'<br><small>'.e('Menu stays on top until you scroll down then it follows').'</small>
                                            </label>
                                            <label class="btn border rounded text-dark px-5 py-4">
                                                <input type="radio" name="menutype" value="top" class="me-2" autocomplete="off" '.($option->menutype == 'top' ? 'checked' : '').'> '.e('Top').'<br><small>'.e('Menu always stays on top').'</small>
                                            </label>
                                        </div>
                                        <button class="btn btn-primary">'.e('Save Settings').'</button>
                                    </div>
