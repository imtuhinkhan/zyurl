                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label fw-bold"><?php ee('QR File Size (kb)') ?></label>
                                            <input type="number" class="form-control" name="sizes[qrfile]" value="<?php echo config('sizes')->qrfile ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label fw-bold"><?php ee('QR CSV Size (kb)') ?></label>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group border rounded mb-2 p-2 mb-3">
                                    ...
                                    <p class="form-text"><?php ee('Separate extensions with comma') ?></p>
                                </div>
