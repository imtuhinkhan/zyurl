<div class="card shadow-sm">
    <div class="card-body">
        <div class="list-group list-group-flush">
            <a class="list-group-item list-group-item-action rounded" href="<?php echo route('admin.settings') ?>"><?php ee('General Settings') ?></a>
            <a class="list-group-item list-group-item-action rounded" href="<?php echo route('admin.settings.config', ['app']) ?>"><?php ee('Application Settings') ?></a>
            <a class="list-group-item list-group-item-action rounded" href="<?php echo route('admin.settings.config', ['link']) ?>"><?php ee('Link Settings') ?></a>
